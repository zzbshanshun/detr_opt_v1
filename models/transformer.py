...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, decoder_layer, num_layers, norm=None, return_intermediate=False, d_model=256):
        ...
        # reference points
        # self.query_map_x = nn.Linear(2, int(d_model/2)) #MLP(2, d_model, d_model, 1)
        # self.query_map_y = nn.Linear(2, int(d_model/2)) #MLP(2, d_model, d_model, 1)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        self.ca_v_proj_pos = nn.Linear(d_model, d_model) # > 0.030 max 0.036
        # self.ca_v_proj_pos = MLP_SIGMOID(d_model, d_model, d_model, 2)
        
        # test cat q and q_pos
        # self.multihead_attn_cat = nn.MultiheadAttention(d_model*2, nhead, dropout=dropout)
        # self.tgt_map_proj = nn.Linear(d_model*2, d_model)
    ...
    def forward_post(self, tgt, memory,
        ...
        # use k = self.ca_kcontent_proj(k_content)
