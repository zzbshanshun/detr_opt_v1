...
if float(torch_ver.split('.')[0]) == 0 or (float(torch_ver.split('.')[0]) == 1 and float(torch_ver.split('.')[1]) < 9):
...
if float(torch_ver.split('.')[0]) == 0 or (float(torch_ver.split('.')[0]) == 1 and float(torch_ver.split('.')[1]) < 7):
